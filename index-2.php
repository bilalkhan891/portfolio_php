...
<!-- Mirrored from frenify.com/envato/marketify/html/ronnie/1/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Jul 2018 06:07:11 GMT -->
<head>
...
<title>Sting HTML 5 Template</title>
		...
		<div class="sting_tm_navigation_wrap">
			<div class="container">
				<div class="navigation_inner">
					<div class="logo">
						<a class="light_logo" href="#"><img src="img/logo/logo.png" alt="" /></a>
						<a class="dark_logo" href="#"><img src="img/logo/logo_dark.png" alt="" /></a>
					</div>
	...
	<div class="sting_tm_content">
						...
						<div class="rightbox">
							...
							<div class="progress_bar_wrap_total">
								<div class="sting_tm_progress_wrap" data-size="small" data-round="c" data-strip="off">
									...
									<div class="sting_tm_progress" data-value="85" data-color="#000">
										<span><span class="label">Photoshop</span><span class="number">85%</span></span>
										<div class="sting_tm_bar_bg"><div class="sting_tm_bar_wrap"><div class="sting_tm_bar"></div></div></div>
									</div>
									<div class="sting_tm_progress" data-value="75" data-color="#000">
							...
							<div class="about_short_contact_wrap">
								<ul>
									...
									<li>
										<span><label>Mail:</label> <a href="index-2.html">example&#64;gmail.com</a></span>
									</li>
								</ul>
							</div>
							<div class="buttons_wrap">
								<ul>
									<li>
										<a href="index-2.html">Download CV</a>
									</li>
									<li class="anchor">
								...
								<ul class="owl-carousel">
									<li class="item">
										<div class="inner">
											...
											<div class="definition">
												<p>Sting team are easy to work with and helped me make amazing websites in a short amount of time. Thanks guys for all your hard work.</p>
											</div>
											<div class="svg_wrap">
									...
									<li class="item">
										<div class="inner">
											...
											<div class="definition">
												<p>We were looking for a logo with a touch of modernism. Sting grasped our needs and produced a stunning design.</p>
											</div>
											<div class="svg_wrap">
												<i class="xcon-quote-left"></i>
											</div>
									...
									<li class="item">
										<div class="inner">
											...
											<div class="definition">
												<p>Awesome to work with Sting. Incredibly organized, easy to communicate with, responsive with next iterations.</p>
											</div>
											<div class="svg_wrap">
												<i class="xcon-quote-left"></i>
											</div>
		...
		<div class="sting_tm_section">
			<div class="sting_tm_footer_wrap">
				<p class="wow fadeIn"  data-wow-duration="1.2s">&copy; Copyright 2018. Theme has been designed by <a href="https://themeforest.net/user/marketify">Marketify</a></p>
			</div>
		</div>
		<!-- /FOOTER -->
...
<!-- Mirrored from frenify.com/envato/marketify/html/ronnie/1/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Jul 2018 06:07:12 GMT -->
</html>